...
{
    public static final String ACTION_WIFI_ENABLED = "in.gopalakrishnareddy.torrent.Receivers.WifiReceiver.ACTION_WIFI_ENABLED";
    public static final String ACTION_WIFI_DISABLED = "in.gopalakrishnareddy.torrent.Receivers.WifiReceiver.ACTION_WIFI_DISABLED";
