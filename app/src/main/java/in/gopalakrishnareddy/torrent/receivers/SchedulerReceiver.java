...
package in.gopalakrishnareddy.torrent.receivers;
...
{
    public static final String ACTION_START_APP = "in.gopalakrishnareddy.torrent.Receivers.SchedulerReceiver.ACTION_START_APP";
    public static final String ACTION_STOP_APP = "in.gopalakrishnareddy.torrent.Receivers.SchedulerReceiver.ACTION_STOP_APP";
    public static final String ACTION_FETCH_FEEDS = "in.gopalakrishnareddy.torrent.Receivers.SchedulerReceiver.ACTION_FETCH_FEEDS";
