...
public class DetailTorrentInfoFragment extends Fragment
{
    ...
    private LinearLayout sequential_download_layout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        sequential_download_layout = v.findViewById(R.id.sequential_download_layout);

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getContext());
        if (prefs.getBoolean("show_sequential_download", true)) {
            sequential_download_layout.setVisibility(View.VISIBLE);
        }else {sequential_download_layout.setVisibility(View.GONE);}
        return v;
    }
