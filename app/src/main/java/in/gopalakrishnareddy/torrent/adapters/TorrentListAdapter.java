...
package in.gopalakrishnareddy.torrent.adapters;
...
public class TorrentListAdapter extends SelectableAdapter<TorrentListAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        if (item.stateCode == TorrentStateCode.DOWNLOADING_METADATA) {
            ...
            holder.circleProgress.setProgress(item.progress);holder.progress.setProgress(item.progress);
        }
        ...
        switch (item.stateCode) {
            case DOWNLOADING:
                stateString = ETA;Utils.setBackground(holder.indicatorCurOpenTorrent, ContextCompat.getDrawable(context, R.color.green));//stateString = context.getString(R.string.torrent_status_downloading);
                break;
            case SEEDING:
                stateString = context.getString(R.string.torrent_status_seeding);
                break;
            case PAUSED:
                stateString = context.getString(R.string.torrent_status_paused);Utils.setBackground(holder.indicatorCurOpenTorrent, ContextCompat.getDrawable(context, R.color.gray));
                break;
            case STOPPED:
        ...
        String counterTemplate = context.getString(R.string.download_counter);//String counterTemplate = context.getString(R.string.download_counter_ETA_template);
        ...
        //holder.downloadCounter.setText(String.format(counterTemplate, receivedBytes, totalBytes, (item.totalBytes == 0 ? 0 : item.progress), ETA));
        holder.downloadCounter.setText(String.format(counterTemplate, receivedBytes, totalBytes));

        String speedTemplate = context.getString(R.string.download_speed_template);//String speedTemplate = context.getString(R.string.download_upload_speed_template);
        ...
        holder.downloadUploadSpeed.setText(String.format(speedTemplate, downloadSpeed));//holder.downloadUploadSpeed.setText(String.format(speedTemplate, downloadSpeed, uploadSpeed));
            ...
            implements View.OnClickListener, View.OnLongClickListener
    {
        ...
        public ViewHolder(View itemView, final ClickListener listener, final List<TorrentListItem> items)
        {
            ...
            circleProgress = itemView.findViewById(R.id.donut_progress);
