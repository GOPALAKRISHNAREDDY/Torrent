...
import in.gopalakrishnareddy.torrent.core.FeedItem;
...
public class FeedFetcherService extends JobIntentService
{
    ...
    public static final String ACTION_FETCH_CHANNEL = "in.gopalakrishnareddy.torrent.services.FeedFetcherService.ACTION_FETCH_CHANNEL";
    public static final String ACTION_FETCH_CHANNEL_LIST = "in.gopalakrishnareddy.torrent.services.FeedFetcherService.ACTION_FETCH_CHANNEL_LIST";
    public static final String ACTION_FETCH_ALL_CHANNELS = "in.gopalakrishnareddy.torrent.services.FeedFetcherService.ACTION_FETCH_ALL_CHANNELS";
    public static final String ACTION_CHANNEL_RESULT = "in.gopalakrishnareddy.torrent.services.FeedFetcherService.ACTION_CHANNEL_RESULT";
