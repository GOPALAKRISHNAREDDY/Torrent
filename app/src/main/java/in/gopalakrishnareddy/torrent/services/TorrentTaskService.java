...
package in.gopalakrishnareddy.torrent.services;
...
import in.gopalakrishnareddy.torrent.receivers.PowerReceiver;
import in.gopalakrishnareddy.torrent.receivers.TorrentTaskServiceReceiver;
import in.gopalakrishnareddy.torrent.receivers.WifiReceiver;
...
import in.gopalakrishnareddy.torrent.MainActivity;
import in.gopalakrishnareddy.torrent.R;
import in.gopalakrishnareddy.torrent.core.AddTorrentParams;
import in.gopalakrishnareddy.torrent.core.ProxySettingsPack;
import in.gopalakrishnareddy.torrent.core.Torrent;
import in.gopalakrishnareddy.torrent.core.TorrentDownload;
import in.gopalakrishnareddy.torrent.core.TorrentEngine;
import in.gopalakrishnareddy.torrent.core.TorrentEngineCallback;
...
import in.gopalakrishnareddy.torrent.core.exceptions.DecodeException;
import in.gopalakrishnareddy.torrent.core.exceptions.FileAlreadyExistsException;
import in.gopalakrishnareddy.torrent.core.exceptions.FreeSpaceException;
import in.gopalakrishnareddy.torrent.core.server.TorrentStreamServer;
        ...
        SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public static final String DEFAULT_CHAN_ID = "in.gopalakrishnareddy.torrent.DEFAULT_CHAN";
    public static final String ACTION_SHUTDOWN = "in.gopalakrishnareddy.torrent.services.TorrentTaskService.ACTION_SHUTDOWN";
    public static final String ACTION_ADD_TORRENT = "in.gopalakrishnareddy.torrent.services.TorrentTaskService.ACTION_ADD_TORRENT";
    public static final String ACTION_ADD_TORRENT_LIST = "in.gopalakrishnareddy.torrent.services.TorrentTaskService.ACTION_ADD_TORRENT_LIST";
    public static final String ACTION_MOVE_TORRENT = "in.gopalakrishnareddy.torrent.services.TorrentTaskService.ACTION_MOVE_TORRENT";
    ...
    public void onTorrentFinished(String id)
    {
        ...
        if (!torrent.isFinished()) {
            ...
            if (pref.getBoolean(getString(R.string.pref_key_shutdown_downloads_complete), SettingsManager.Default.shutdownDownloadsComplete)){
                task.pause();
            }
