...
import in.gopalakrishnareddy.torrent.fragments.FeedFragment;
...
public class FeedActivity extends AppCompatActivity implements FragmentCallback
{
    ...
    public static final String ACTION_ADD_CHANNEL_SHORTCUT = "in.gopalakrishnareddy.torrent.ADD_CHANNEL_SHORTCUT";
