...
package in.gopalakrishnareddy.torrent.settings;
        ...
        Preference.OnPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        shutdownComplete.setVisible(false);
        ...
        batteryControl.setVisible(false); //hide battery settings
        ...
        customBatteryControl.setVisible(false); //hide battery settings
        ...
        customBatteryControlValue.setVisible(false); //hide battery settings
