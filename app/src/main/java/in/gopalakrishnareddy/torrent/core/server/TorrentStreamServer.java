...
package in.gopalakrishnareddy.torrent.core.server;

import android.util.Log;

import in.nanohttpd.protocols.http.IHTTPSession;
import in.nanohttpd.protocols.http.NanoHTTPD;
import in.nanohttpd.protocols.http.response.Response;
import in.gopalakrishnareddy.torrent.core.TorrentDownload;
import in.gopalakrishnareddy.torrent.core.TorrentEngine;
import in.gopalakrishnareddy.torrent.core.TorrentInputStream;
import in.gopalakrishnareddy.torrent.core.TorrentStream;
...
import static in.nanohttpd.protocols.http.response.Response.newFixedLengthResponse;
import static in.nanohttpd.protocols.http.response.Status.BAD_REQUEST;
import static in.nanohttpd.protocols.http.response.Status.FORBIDDEN;
import static in.nanohttpd.protocols.http.response.Status.NOT_FOUND;
import static in.nanohttpd.protocols.http.response.Status.NOT_MODIFIED;
import static in.nanohttpd.protocols.http.response.Status.OK;
import static in.nanohttpd.protocols.http.response.Status.PARTIAL_CONTENT;
import static in.nanohttpd.protocols.http.response.Status.RANGE_NOT_SATISFIABLE;
